...
function lazyload() {
  for (
    var e = document.getElementsByClassName("lazy"), t = 0;
    t < e.length;
    t++
  )
    elementInViewport(e[t]) &&
...
function elementInViewport(e) {
  ...
  return (
    t.top >= 0 &&
    t.left >= 0 &&
    t.bottom <= (window.innerHeight || document.documentElement.clientHieght) &&
...
!(function(e, t) {
  ...
  var x = (function(e) {
    ...
    function ae(e, t, i, o) {
      ...
      if (
        !o &&
        ((t ? t.ownerDocument || t : w) !== f && h(t), (t = t || f), g)
      ) {
        if (11 !== C && (d = Z.exec(e)))
          if ((r = d[1])) {
            if (9 === C) {
            ...
            } else if (y && (c = y.getElementById(r)) && _(t, c) && c.id === r)
              return i.push(c), i;
          } else {
      ...
      return (
        ...
        ce(function(r, s, a, l) {
          var c,
            ...
            v = n ? (o || (r ? e : p || i) ? [] : s) : m;
          if ((n && n(m, v, a, l), i))
            for (c = Ce(v, f), i(c, [], a, l), u = c.length; u--; )
              (d = c[u]) && (v[f[u]] = !(m[f[u]] = d));
          if (r) {
            if (o || e) {
              if (o) {
          ...
          (m = S(
            ...
            (u = function(e, t, n, s, u) {
              ...
              if (((v += y), a && y !== v)) {
                ...
                if (e) {
                  if (0 < v) for (; y--; ) _[y] || b[y] || (b[y] = N.call(s));
                  b = Ce(b);
                }
                L.apply(s, b),
                  u &&
        ...
        if (((n = n || []), 1 === f.length)) {
          ...
          for (
            ...
            if (
              ...
              if ((l.splice(r, 1), !(e = o.length && _e(l))))
  ...
  (w.filter = function(e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function(e) {
        return !!k(this, "string" == typeof e && A.test(e) ? w(e) : e || [], !1)
          .length;
      }
    });
  var N,
  ...
  function we(e, t, n, i, o) {
    ...
    for (d.textContent = "", f = 0; (r = h[f++]); )
      if (i && -1 < w.inArray(r, i)) o && o.push(r);
        ...
        ((c = re(r)), (s = me(d.appendChild(r), "script")), c && ve(s), n)
      )
          ...
          handler: function(e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (s.length)
                ...
                (i = n(this, t)),
                this[t](),
                s !== (o = Y.get(this, t)) || i ? Y.set(this, t, !1) : (o = {}),
                s !== o)
              )
                return (
    ...
    special: {
      ...
      click: {
        setup: function(e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && I(t, "input") && De(t, "click", Te),
            !1
          );
        },
        trigger: function(e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && I(t, "input") && De(t, "click"), !0
          );
        },
        _default: function(e) {
          var t = e.target;
  ...
  function qe(e, t, n, i) {
    ...
    if (
      ...
      for (l = (a = w.map(me(o, "script"), He)).length; d < h; d++)
        (c = o),
          d !== f &&
  ...
  function et(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += w.css(e, n + ie[s], !0, o)),
        i
          ? ("content" === n && (l -= w.css(e, "padding" + ie[s], !0, o)),
            "margin" !== n &&
        ...
        if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && de([e], !0),
              h.done(function() {
                for (i in (g || de([e]), Y.remove(e, "fxshow"), f))
                  w.style(e, i, f[i]);
              })),
              (l = ht(g ? m[i] : 0, i, h)),
              i in m ||
      ...
      toggleClass: function(e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function() {
              var t, o, r, s;
              if (i)
                for (o = 0, r = w(this), s = bt(e); (t = s[o++]); )
                  r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = _t(this)) && Y.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  w.extend(w.event, {
    trigger: function(t, n, o, r) {
      ...
      if (
        ...
        if (!r && !f.noBubble && !m(o)) {
          for (
            c = f.delegateType || y, Ct.test(c + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (l = a);
        ...
        for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
          (p = a),
            (t.type = 1 < s ? c : f.bindType || y),
            (h = (Y.get(a, "events") || {})[t.type] && Y.get(a, "handle")) &&
              h.apply(a, n),
            (h = u && a[u]) &&
              h.apply &&
              V(a) &&
        ...
        return (
          ...
          r ||
            ...
            (u &&
              ...
              ((l = o[u]) && (o[u] = null),
              (w.event.triggered = y),
              t.isPropagationStopped() && p.addEventListener(y, Et),
              o[y](),
              t.isPropagationStopped() && p.removeEventListener(y, Et),
  ...
  (Ft.href = xt.href),
    w.extend({
      ...
      ajax: function(t, n) {
        ...
        if (p.beforeSend && (!1 === p.beforeSend.call(g, x, p) || u))
          return x.abort();
        if (
          ((E = "abort"),
          y.add(p.complete),
          ...
          if (((x.readyState = 1), d && m.trigger("ajaxSend", [x, p]), u))
            return x;
          p.async &&
            0 < p.timeout &&
            ...
            c
              ? (p.ifModified &&
                  ((C = x.getResponseHeader("Last-Modified")) &&
                    (w.lastModified[r] = C),
                  (C = x.getResponseHeader("etag")) && (w.etag[r] = C)),
                204 === t || "HEAD" === p.type
                  ? (E = "nocontent")
                  : 304 === t
                  ? (E = "notmodified")
                  : ((E = b.state), (h = b.data), (c = !(f = b.error))))
              : ((f = E), (!t && E) || ((E = "error"), t < 0 && (t = 0))),
            (x.status = t),
            (x.statusText = (n || E) + ""),
            c ? v.resolveWith(g, [h, E, x]) : v.rejectWith(g, [x, E, f]),
            x.statusCode(_),
            (_ = void 0),
            d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [x, p, c ? h : f]),
            y.fireWith(g, [x, E]),
            d &&
  ...
  w.ajaxSetup({
    ...
    (p.createHTMLDocument =
      (((Kt = i.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    w.each(["top", "left"], function(e, t) {
      w.cssHooks[t] = Ue(p.pixelPosition, function(e, n) {
        if (n)
          return (n = We(e, t)), Me.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
  ...
  (function(e, t) {
      ...
      Se = (function() {
        ...
        return (
          ...
          (n._showElement = function(e) {
            ...
            var o = t.Event(_e.SHOWN, { relatedTarget: e }),
              r = function() {
          ...
          (e._jQueryInterface = function(n, i) {
            return this.each(function() {
              ...
              if (
                (o || ((o = new e(this, s)), t(this).data(pe, o)),
                "string" == typeof n)
              ) {
                if (void 0 === o[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    t(document).on(_e.CLICK_DATA_API, '[data-toggle="modal"]', function(e) {
      ...
      (t.fn[fe] = Se._jQueryInterface),
      (t.fn[fe].Constructor = Se),
            ...
            a.forEach(function(e) {
              (function(e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === Ae.indexOf(n) ||
                    Boolean(e.nodeValue.match(Ie) || e.nodeValue.match(De))
                  );
                for (
        ...
        return (
          ...
          (i._enter = function(e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              e && (n._activeTrigger["focusin" === e.type ? ze : Qe] = !0),
              t(n.getTipElement()).hasClass(Ue) || n._hoverState === Fe
                ? (n._hoverState = Fe)
          ...
          (i._leave = function(e, n) {
            ...
            (n = n || t(e.currentTarget).data(i)) ||
              ...
              t(e.currentTarget).data(i, n)),
              e && (n._activeTrigger["focusout" === e.type ? ze : Qe] = !1),
          ...
          (e._jQueryInterface = function(n) {
            return this.each(function() {
              ...
              if (
                ...
                (i || ((i = new e(this, o)), t(this).data(Oe, i)),
                "string" == typeof n)
              ) {
                if (void 0 === i[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (t.fn[Ne] = Ke._jQueryInterface),
      (t.fn[Ne].Constructor = Ke),
          ...
          (r._jQueryInterface = function(e) {
            return this.each(function() {
              ...
              if (
                ...
                (n || ((n = new r(this, i)), t(this).data(Xe, n)),
                "string" == typeof e)
              ) {
                if (void 0 === n[e])
          ...
          (n.show = function() {
            ...
            if (
              ...
              var l = t.Event(wt.HIDE, { relatedTarget: this._element }),
                c = t.Event(wt.SHOW, { relatedTarget: i });
              if (
                (i && t(i).trigger(l),
                ...
                var u = function() {
                  var n = t.Event(wt.HIDDEN, { relatedTarget: e._element }),
                    o = t.Event(wt.SHOWN, { relatedTarget: i });
        ...
        return (
          ...
          (e._jQueryInterface = function(n) {
            return this.each(function() {
              ...
              if (
                (o ||
                  ((o = new e(this, "object" == typeof n && n)), i.data(At, o)),
                "string" == typeof n)
              ) {
                if (void 0 === o[n])
                  throw new TypeError('No method named "' + n + '"');
        ...
        r = (function() {
          function n(t, i) {
            ...
            (function(e, t) {
              ...
              (this._$element = t instanceof jQuery ? t : e(t)),
              (this._isBootstrap3 = 3 == e.fn.modal.Constructor.VERSION[0]);
            var s =
              ...
              l =
                ...
                ('<div class="modal-footer' +
                  ...
                  "</div>") +
                "</div></div>";
            e(this._config.doc.body).append(
              '<div id="' +
                this._modalId +
              ...
              (this._$modal = e("#" + this._modalId, this._config.doc)),
              ...
              this._galleryName &&
                ((this._$galleryItems = e(document.body).find(
              ...
              this._$modal
                ...
                .on("hidden.bs.modal", function() {
                  return (
                    r._galleryName &&
                      (e(document).off("keydown.ekkoLightbox"),
                      e(window).off("resize.ekkoLightbox")),
                    r._$modal.remove(),
                    r._config.onHidden.call(r)
                  );
                })
                .modal(this._config),
              e(window).on("resize.ekkoLightbox", function() {
            ...
            t(
              ...
              [
                ...
                },
                {
                  key: "navigateTo",
                  value: function(t) {
                    return t < 0 || t > this._$galleryItems.length - 1
                      ? this
                      : ((this._galleryIndex = t),
                        this.updateNavigation(),
                        (this._$element = e(
                ...
                },
                {
                  ...
                  value: function() {
                    if (!this._config.wrapping) {
                      var e = this._$lightboxContainer.find(
                        "div.ekko-lightbox-nav-overlay"
                      );
                      0 === this._galleryIndex
                        ? e.find("a:first-child").addClass("disabled")
                        : e.find("a:first-child").removeClass("disabled"),
                        this._galleryIndex === this._$galleryItems.length - 1
                          ? e.find("a:last-child").addClass("disabled")
                          : e.find("a:last-child").removeClass("disabled");
                    }
                  }
                },
                {
                ...
                },
                {
                  ...
                  value: function(e) {
                    return 39 === (e = e || window.event).keyCode
                      ? this.navigateRight()
                      : 37 === e.keyCode
                      ? this.navigateLeft()
                      : void 0;
                ...
                },
                {
                  ...
                  value: function(e, t) {
                    return (
                      !(t = t || !1) && this._isImage(e) && (t = "image"),
                      !t && this._getYoutubeId(e) && (t = "youtube"),
                      !t && this._getVimeoId(e) && (t = "vimeo"),
                      !t && this._getInstagramId(e) && (t = "instagram"),
                      ("audio" == t ||
                        "video" == t ||
                        (!t && this._isMedia(e))) &&
                        (t = "media"),
                ...
                },
                {
                  ...
                  value: function(e) {
                    return (
                      e && e.match(/(\.(mp3|mp4|ogg|webm|wav)((\?|#).*)?$)/i)
                    );
                  }
                },
                {
                  ...
                  value: function() {
                    ...
                    return (
                      this._$lightboxBodyTwo.hasClass("in") &&
                        ((t = this._$lightboxBodyOne),
                        (n = this._$lightboxBodyTwo)),
                      n.removeClass("in show"),
                      setTimeout(function() {
                        e._$lightboxBodyTwo.hasClass("in") ||
                          e._$lightboxBodyTwo.empty(),
                          e._$lightboxBodyOne.hasClass("in") ||
                            e._$lightboxBodyOne.empty();
                      }, 500),
                      t.addClass("in show"),
                      t
                    );
                ...
                },
                {
                  ...
                  value: function(e) {
                    return (
                      parseInt(this._$modalDialog.css(e), 10) +
                      parseInt(this._$modalContent.css(e), 10) +
                      parseInt(this._$modalBody.css(e), 10)
                    );
                  }
                },
                {
                  ...
                  value: function() {
                    ...
                    return (
                      (this._titleIsShown = !1),
                      e || this._config.alwaysShowClose
                      ...
                      t
                        ? ((this._footerIsShown = !0),
                          this._$modalFooter.css("display", "").html(t))
                  ...
                  value: function(t, n) {
                    if (this._$galleryItems) {
                      ...
                      if (void 0 !== i) {
                        ...
                        return (
                          ("image" === i.attr("data-type") ||
                            this._isImage(o)) &&
                            this._preloadImage(o, !1),
                          n > 0
                            ? this._preloadImageByIndex(t + 1, n - 1)
                            : void 0
                        );
                      }
                    }
                    ...
                    return (
                      n &&
                        ...
                        (r.onload = function() {
                          ...
                          return (
                            t.attr("src", r.src),
                            t.addClass("img-fluid"),
                            t.css("width", "100%"),
                            n.html(t),
                            i._$modalArrows &&
                              i._$modalArrows.css("display", ""),
                            i._resize(r.width, r.height),
                            i._toggleLoading(!1),
                            i._config.onContentLoaded.call(i)
                          );
                        }),
                        (r.onerror = function() {
                          return (
                            i._toggleLoading(!1),
                            i._error(i._config.strings.fail + "  " + t)
                          );
                        })),
                      (r.src = t),
                      r
                ...
                },
                {
                  ...
                  value: function(t, n) {
                    ...
                    var i = t / n,
                      ...
                      a = Math.min(
                        t + o,
                        this._config.doc.body.clientWidth - r,
                    ...
                    var l = 0,
                      c = 0;
                    this._footerIsShown &&
                      (c = this._$modalFooter.outerHeight(!0) || 55),
                      this._titleIsShown &&
                    ...
                    var u =
                      ...
                      h = Math.min(
                        n,
                        e(window).height() - u - d - l - c,
                        this._config.maxHeight - u - l - c
                      );
                    n > h && (t = Math.ceil(h * i) + o),
                      this._$lightboxContainer.css("height", h),
                      this._$modalDialog.css("flex", 1).css("maxWidth", t);
            ...
            var m,
              ...
              T = f
                ...
                : (function(t, n, i, r) {
                    ...
                    return (
                      (s = Math.max(s - n - i, 0)),
                      r && (s = Math.min(s, o() - e.innerHeight)),
                      s
                    );
                  })(
                    p,
              ...
              D =
                ((m = S),
                (y = (v = c).speedAsDuration
                  ? v.speed
                  : Math.abs((m / 1e3) * v.speed)),
              ...
              k = function(t) {
                ...
                _ || (_ = t),
                  ...
                  (w =
                    g +
                    S *
                      ((o = b = 1 < (b = 0 === D ? 0 : I / D) ? 1 : b),
                      "easeInQuad" === (n = c).easing && (a = o * o),
                      "easeOutQuad" === n.easing && (a = o * (2 - o)),
                      "easeInOutQuad" === n.easing &&
                        (a = o < 0.5 ? 2 * o * o : (4 - 2 * o) * o - 1),
                  ...
                  (function(t, n) {
                    var o,
                      ...
                      l,
                      u = e.pageYOffset;
                    if (t == n || u == n || (g < n && e.innerHeight + u) >= A)
                      return (
                        h.cancelScroll(!0),
                        (a = n),
                        (l = f),
            ...
            0 === e.pageYOffset && e.scrollTo(0, 0),
              ...
              f ||
                (history.pushState &&
                  E.updateURL &&
                  history.pushState(
                    { smoothScroll: JSON.stringify(E), anchor: C.id },
                    document.title,
...
(platformName = ua.match(/ip(?:ad|od|hone)/)
  ...
  $(".callModelRK").click(function() {
    ...
    $(".rkModalTitle").text(e),
      $(".rk-modal-btn").text(t),
      "lg" == n &&
        ($(".rk-form-mail").removeClass("hide"),
        $(".rk-form-mail").addClass("show"),
        $(".rk-form-comm").removeClass("hide"),
        $(".rk-form-comm").addClass("show")),
      "md" == n &&
        ($(".rk-form-comm").removeClass("show"),
        $(".rk-form-comm").addClass("hide"),
        $(".rk-form-mail").removeClass("hide"),
        $(".rk-form-mail").addClass("show")),
      "sm" == n &&
        ($(".rk-form-comm").removeClass("show"),
        $(".rk-form-comm").addClass("hide"),
        $(".rk-form-mail").removeClass("show"),
        $(".rk-form-mail").addClass("hide"));
  }),
...
$(document).on("click", '[data-toggle="lightbox"]', function(e) {
  ...
  $(".ami-btn").click(function() {
    $(".ami-btn").toggleClass("hide"),
      $(".ami-div").toggleClass("ami-div-h"),
      $(".ami-btn-block").toggleClass("bg-white");
  }),
  ...
  $(document).keydown(function(e) {
    return (
      ...
      !(
        ...
        (e.ctrlKey && e.shiftKey && 740 == e.keyCode) ||
